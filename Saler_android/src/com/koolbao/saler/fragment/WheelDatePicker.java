...
import com.koolbao.saler.wheeldatepicker.NumericWheelAdapter;
import com.koolbao.saler.wheeldatepicker.OnWheelChangedListener;
import com.koolbao.saler.wheeldatepicker.WheelView;
...
public class WheelDatePicker extends PopupWindow implements OnClickListener {
	...
	public WheelDatePicker(Context context, String age, TextView date_tv) {
		super(context);
		mContext = context;
		this.age = age;
		this.date_tv = date_tv;
		LayoutInflater inflater = LayoutInflater.from(mContext);  
		mMenuView = inflater.inflate(R.layout.wheel_datepicker, null);
